...
![[PRML_10_3.png]]
(Source: Pattern Recognition and Machine Learning (Bishop, 2006), figure 10.3)

2. **Zero avoiding vs zero forcing**
![[PRML_10_2.png]]
(Source: Pattern Recognition and Machine Learning (Bishop, 2006), figure 10.2)
...
$$
D_{KL}(q(z)||p(x)) = \int q(z) log(\frac{q(z)}{p(x)})
dx$$
